    ...
    <main className='grid lg:grid-cols-[1fr,45vw]'>
      <div className='relative hidden items-center justify-center  lg:flex'>
        <NextImage
          ...
          src='/assets/vibra-banner.png'
          alt='Vibra banner'
          layout='fill'
          useSkeleton
        />
        <i className='absolute'>
          <CustomIcon className='h-96 w-96 text-white' iconName='VibraIcon' />
        </i>
      </div>
      <div className='flex flex-col items-center justify-between gap-6 p-8 lg:items-start lg:justify-center'>
        <i className='mb-0 self-center lg:mb-10 lg:self-auto'>
          <CustomIcon
            className='-mt-4 h-6 w-6 text-accent-blue lg:h-12 lg:w-12 dark:lg:text-vibra-icon'
            iconName='VibraIcon'
          />
        </i>
        <div className='flex max-w-xs flex-col gap-4 font-vibra-chirp-extended lg:max-w-none lg:gap-16'>
        ...
        <div className='flex max-w-xs flex-col gap-6 [&_button]:py-2'>
          <div className='grid gap-3 font-bold'>
            ...
            >
              ...
              <a
                href='https://social.chillspot.it/tos'
                target='_blank'
                rel='noreferrer'
              >
                Terms of Service
              ...
              and{' '}
              <a
                href='https://social.chillspot.it/privacy'
                target='_blank'
                rel='noreferrer'
              >
                Privacy Policy
              ...
              , including{' '}
              <a
                href='https://social.chillspot.it/cookies'
                target='_blank'
                rel='noreferrer'
              >
                Cookie Use
